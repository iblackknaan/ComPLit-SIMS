...
if (isset($_GET['query'])) {
    ...
    echo "</tr>";
        ...
        echo "</table>";
        echo "<br>";
        echo '<a href="teachers_list.php" class="btn btn-sm btn-info text-center" style="display: block; margin: 0 auto;">Close Search</a>';
        echo "<br>";
    } else {
...
?>
    ...
    if ($students) {
      echo "<table class='table mx-auto' style='border-collapse: collapse;'>
                <tr>
                    <th style='border: 1px solid black;'>Teacher ID</th>
        ...
        foreach ($students as $student) {
            echo "<tr>
                    ...
                    <td style='border: 1px solid black;'>{$student['UniqueID']}</td>                    
                    ...
                    <td style='border: 1px solid black;'>{$student['HireDate']}</td>
                    <td style='border: 1px solid black;'>{$student['Qualification']}</td>
                    <td style='border: 1px solid black;'>{$student['Experience']}</td>                    
                </tr>";
        }
        echo "</table>";
    } else {
